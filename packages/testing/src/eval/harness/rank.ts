...
import type { Profile, Usage } from "@behalf-js/core";
...
/** One variant's outcome — score, usage, and time-to-complete. @public */
...
/** Faster (lower time-to-complete) first. @public */
export const byTimeToComplete: Rank = (metrics) => -metrics.timeToComplete;
